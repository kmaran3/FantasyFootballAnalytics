...
csv_files = [
    {'file': 'Models/PickleFiles/Full PPR Rankings with Weighted VBD.pkl', 'table_name': 'Full_PPR'},
    {'file': 'Models/PickleFiles/Half PPR Rankings with Weighted VBD.pkl', 'table_name': 'Half_PPR'},
    {'file': 'Models/PickleFiles/Non PPR Rankings with Weighted VBD.pkl', 'table_name': 'Non_PPR'}
]
...
conn = sqlite3.connect('webapp/my_database.db')
